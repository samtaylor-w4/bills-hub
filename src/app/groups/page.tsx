          ...
          <div className="col-md-6" key={g.id}>
            <div className="card h-100">
              <div className="card-body">
                ...
                <div className="text-muted small">Members: {g.members.join(', ')}</div>
                <div className="text-muted small">Default split: {g.default}</div>
                <a className="btn btn-sm btn-outline-secondary mt-2" href="/ledger">View ledger</a>
              </div>
            </div>
          </div>
        ))}
